const parts_data = [
    ...
    },
    {
        ...
        sections: [
            ...
            {
                name: "美化セクション",
                desc: "菁々祭で使用するゴミの管理を担当します。",
                details: ["菁々祭を清潔に保つ、縁の下の力持ちです！", "当日のシフトを決めるだけです。", "定期的にゴミ箱を点検し、ゴミを回収します。", "美化セクション長は76期の人にやってもらおうと思ってるので興味がある人はぜひ！"],
                status: { 難しさ: 20, 自由度: 100, 楽しさ: 70 },
            },
        ],
    },
    {
